           ...
           <div className="about-layout" style={{ alignItems: 'flex-start' }}>
              ...
              <div className="about-content reveal" style={{ flex: 1, width: '100%' }}>
                 ...
                 <form style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                       <input type="text" placeholder="First Name" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '1rem', color: 'white', borderRadius: '4px' }} />
                       <input type="text" placeholder="Last Name" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '1rem', color: 'white', borderRadius: '4px' }} />
                    </div>
                    <input type="email" placeholder="Email Address" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '1rem', color: 'white', borderRadius: '4px', width: '100%' }} />
                    <input type="tel" placeholder="Phone Number" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '1rem', color: 'white', borderRadius: '4px', width: '100%' }} />
                    <select style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '1rem', color: '#a8a29e', borderRadius: '4px', width: '100%' }}>
                    ...
                    <textarea placeholder="Your Message" rows="4" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '1rem', color: 'white', borderRadius: '4px', width: '100%' }}></textarea>
                    <button type="button" className="btn-primary" style={{ alignSelf: 'flex-start', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div className="about-image-wrapper reveal" style={{ flex: 1, minHeight: '500px', backgroundColor: '#44403c', position: 'relative' }}>
                 <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#a8a29e', opacity: 0.5 }}>
                    ...
                    <span style={{ textTransform: 'uppercase', letterSpacing: '0.1em' }}>Map Visualization</span>
                 </div>
                 {/* Overlay Card */}
